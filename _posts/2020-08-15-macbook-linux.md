...
```  
and that should solve the issue! I can't confirm whether this works with all distributions, but as it's a modprobe.d file, I can imagine it working well across numerous different distributions.
